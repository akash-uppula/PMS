...
const ManagerEmployeeSalesReport = () => {
  ...
  const fetchEmployeeReport = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await api.get("/manager/sales-report", {
        params: filters,
      });
      ...
      console.error(err);
      triggerNotification("Failed to fetch employee sales report.", "danger");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="container-fluid py-4">
      ...
      <div className="d-flex justify-content-between align-items-center py-3 flex-wrap">
        <h3 className="fw-bold mb-0">Employee Sales Report</h3>
        <form
                    ...
                    {reportData.length ? (
                      ...
                      <tr>
                        <td colSpan="6" className="text-center py-4 text-muted">
                          No employee sales data found for the selected range.
                        </td>
                      </tr>
                    )}
                  </tbody>
...
export default ManagerEmployeeSalesReport;
